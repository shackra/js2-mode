...
;;  (print (js2-node-string (car names)))	
  (if (not names)
      (if (not cur-node) nil	
...
;;	(print "parent") (print (js2-node-string parent))
	  (cond ((js2-var-init-node-p parent)
		...
		((js2-object-prop-node-p parent)
		 (js2-object-prop-node-left parent))))) ;;from right to left
    
;;    (print "cur-node-:") (print (js2-node-string cur-node))
...
;;      (print "find symbol in: ") (print (js2-node-string cur-node)) (print (js2-node-string (pl-scope-of-node cur-node))) (print "::")
      (js2-visit-ast
       scope
       (lambda (node endp)
;;	 (print "visit: ") (print (js2-node-string node))
	 (when (and (not endp) (< (js2-node-abs-pos node) (js2-node-abs-pos cur-node)))
	   ...
	   (let (left right)
		 ...
		 (when (pl-js2-name-subset-p left-names names)
		   ;;		 (print "right") (print (js2-node-string right))
		   (setq care-node-names (list right left-names))))))
	   t)))
;;      (print "names-inner-:")  (mapc (lambda (x) (print (js2-node-string x))) names)
;;      (print "length:") (print (length (js2-compute-nested-prop-get (car care-node-names))))
      (setq names (nthcdr (length (cadr care-node-names)) names))
;;      (print "names-inner:")  (mapc (lambda (x) (print (js2-node-string x))) names)
;;      (print "care-node:") (print (js2-node-string (car care-node-names)))
